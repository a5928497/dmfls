...
public class OpenRecordService {
    ...
    public OpenRecord save(OpenRecord openRecord) {
        openRecord = openRecordRepo.save(openRecord);
        return openRecord;
    }

    public OpenRecord findById(Integer id) {
        OpenRecord openRecord = openRecordRepo.findOne(id);
        return openRecord;
    }
